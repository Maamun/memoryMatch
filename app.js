(function avoideGlobal() {
	...
	function hoverInBg(cell) {
		cell.addEventListener('mouseenter', function(e) {
			if (this.clicked === false && this.completed === false) {
				cell.style.backgroundColor = '#E6E6EA';
			}
		});
	}
	function hoverOutBg(cell) {
		cell.addEventListener('mouseleave', function(e) {
			if (this.clicked === false && this.completed === false) {
				cell.style.backgroundColor = '#6B717E';
			}
		});
	}
	// Set timeCounter
	...
	function revealCell(cell) {
		...
		cell.style.backgroundColor = '#333745';
		cell.clicked = true;
	}
	...
	function completeCell(cell) {
		numCompleted++;
		cell.style.backgroundColor = '#E63462';
		cell.completed = true;
	}
		...
		cell.addEventListener('click', function(e) {
			...
			if (clickedArray.length === 2) {
				if (clickedArray[0].value === clickedArray[1].value) {
					...
					if (numCompleted === 8) {
						clickedArray[1].style.backgroundColor = '#1D3557';
